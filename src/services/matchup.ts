...
import { determineResult, extractWinningTechnique, parseRank, parseRecord } from '@/parsers'
import { validateAndLogHTMLDate } from '@/services/matchup-validator'
...
export { parseRank, parseRecord, determineResult, extractWinningTechnique } from '@/parsers'
export { fetchMatchupData } from '@/services/matchup-fetcher'
export { validateHTMLDate, validateAndLogHTMLDate } from '@/services/matchup-validator'
